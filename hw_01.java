...
//  Ответ:  NumberFormatException, NullPointerException, ArrayIndexOutOfBoundsException, IndexOutOfBoundsException, Exception
...
Важно: При выполнении метода единственное исключение, которое пользователь может увидеть - RuntimeException, т.е. ваше.*/
    ...
    //Задание 6(с презентации) Создайте boolean метод, который запросит у пользователя поля: login, password и confirm password
